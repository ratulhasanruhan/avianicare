...
import 'package:avianicare/app/modules/promotion/views/promotion_wise_product_screen.dart';
import 'package:avianicare/widgets/shimmer/promotion_banner_shimmer.dart';
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            print("send slug = ${promotion[index].slug}");
