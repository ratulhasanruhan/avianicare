...
import 'package:avianicare/app/modules/profile/widgets/image_size_chekcer.dart';
import 'package:avianicare/data/model/pages_model.dart';
import 'package:avianicare/data/model/profile_address_model.dart';
import 'package:avianicare/data/model/profile_model.dart';
import 'package:avianicare/data/model/total_complete_orders_model.dart';
import 'package:avianicare/data/model/total_orders_count_model.dart';
import 'package:avianicare/data/model/total_return_orders_model.dart';
import 'package:avianicare/data/model/total_wallet_balance.dart';
import 'package:avianicare/data/repository/profile_repo.dart';
...
class ProfileController extends GetxController {
  ...
  getProfile() async {
    ...
    accountBalance.value =
        double.parse(profileModel?.data?.balance.toString() ?? "0");
