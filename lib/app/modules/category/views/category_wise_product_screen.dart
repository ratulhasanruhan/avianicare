...
import 'package:avianicare/app/modules/search/controller/search_controller.dart';
...
import 'package:avianicare/widgets/appbar4.dart';
import 'package:avianicare/widgets/shimmer/trendy_collections_shimmer.dart';
...
class _CategoryWiseProductScreenState extends State<CategoryWiseProductScreen> {
  ...
  @override
  void initState() {
    print("product model slug = ${widget.categoryModel?.slug}");
