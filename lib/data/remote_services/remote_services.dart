...
import 'package:avianicare/app/modules/cart/model/product_model.dart';
import 'package:avianicare/app/modules/category/controller/category_wise_product_controller.dart';
import 'package:avianicare/app/modules/category/model/category_tree.dart';
import 'package:avianicare/app/modules/category/model/category_wise_product.dart';
import 'package:avianicare/app/modules/coupon/model/apply_coupon.dart';
import 'package:avianicare/app/modules/home/model/brand_model.dart';
import 'package:avianicare/app/modules/home/model/category_model.dart';
...
import 'package:avianicare/app/modules/language/model/language_model.dart';
import 'package:avianicare/app/modules/promotion/model/promotion_wise_product.dart';
import 'package:avianicare/app/modules/shipping/model/area_shipping.dart';
import 'package:avianicare/app/modules/payment/model/paymet_method.dart';
import 'package:avianicare/app/modules/product_details/model/children_variation.dart';
import 'package:avianicare/app/modules/product_details/model/initial_variation.dart';
...
import 'package:avianicare/app/modules/shipping/model/coupon.dart';
import 'package:avianicare/app/modules/shipping/model/outlet_model.dart';
import 'package:avianicare/app/modules/shipping/model/show_address.dart';
import 'package:avianicare/data/model/country_code_model.dart';
import 'package:avianicare/data/model/setting_model.dart';
import 'package:avianicare/data/server/app_server.dart';
...
class RemoteServices {
  ...
  Future<Either<String, CategoryWiseProduct>> fetchCategoryWiseProduct({
    ...
    print("Fetch category data = ${response.data}");
  ...
  Future<Either<String, PromotionWiseProductModel>> fetchPromotionWiseProduct(
    ...
    try {
      final response = await AppServer().getRequestNoToken(
        endPoint: ApiList.promotionWiseProduct(slug: promotionSlug),
      );

      print("Promotion = ${response.data}");
